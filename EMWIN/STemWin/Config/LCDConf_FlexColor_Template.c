...
void LCD_X_Config(void) {
	...
	}else if(lcddev.id == 0X5310 || lcddev.id == 0X6804) //0X5510 0X6804为3.5寸 320x480
	{
		...
		{
//			GUI_TOUCH_SetOrientation(GUI_SWAP_XY|GUI_MIRROR_Y); //正点原子原方法不可行，原因未知
			GUI_TOUCH_Calibrate(GUI_COORD_X,0,480,100,3990);
			GUI_TOUCH_Calibrate(GUI_COORD_Y,0,320,3990,210);
		}
	}
